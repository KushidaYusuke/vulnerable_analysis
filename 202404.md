...
Inspectorから入力した場合、エスケープされてしまうみたい
![alt text](image-4.png)

p.262 interceptモードに切り替え
![alt text](image-6.png)

注意:次の画面で切り替えられると思ったけど、
起動時にオンにするかオフにするかを決める設定だった
![](image-5.png)


### 4/30
商品の検索欄で例えば1500と入れるとSQL分が出てくるけど、これも脆弱性だよね
![alt text](image-11.png)


とりあえず7-6でやった脆弱性に対して一通り書く、そのあとは脆弱性診断の表や本の7-7のヒントを参考にして書く

リスク評価はとりあえずIPAのweb健康診断表を参考にする

Burp Suiteで文字化けしてたけど、設定を次のように変更したらとりあえず解決した
![](image-18.png)